    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            ...
            <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <input type="number" class="form-control" name="price" value="{{ $product->name }} id="price"
                    min="100" max="1000000" value="0">

                <label for="description">Description du produit</label>
                <textarea name="description" id="description" placeholder="Saisir la description ici" class="form-control"
                    rows="4" class="form-control">{{ $product->name }}</textarea><br />
